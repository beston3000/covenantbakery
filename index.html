...
<body>
  <div class="container">
    <div class="header">
      <img src="logo.png" alt="Covenant Hills Bakery Logo" class="header-logo">
      <h1>Covenant Hills Bakery</h1>
      <p>Fresh homemade goods in Covenant Hills</p>
    </div>
    ...
    <div id="location-verification" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.8); z-index: 10000; display: flex; align-items: center; justify-content: center;">
      <div style="background: white; padding: 40px; border-radius: 20px; text-align: center; max-width: 500px; margin: 20px;">
        <h2 style="color: #d4691a; margin-bottom: 20px;">📍 Location Verification Required for Delivery</h2>
        <p style="margin-bottom: 20px; color: #666; line-height: 1.6;">
          We offer delivery exclusively to Covenant Hills. Please share your location to enable this option. Pickup is available to all customers in our service area.
        </p>
    ...
    <div id="location-denied" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.9); z-index: 10000; display: flex; align-items: center; justify-content: center;">
      <div style="background: white; padding: 40px; border-radius: 20px; text-align: center; max-width: 500px; margin: 20px;">
        <h2 style="color: #dc3545; margin-bottom: 20px;">❌ Outside Service Area</h2>
        <p style="margin-bottom: 20px; color: #666; line-height: 1.6;">
          Sorry! We currently only serve customers in Covenant Hills and Ladera Ranch for pickup or delivery.
        </p>
    ...
    <div class="tab-container">
      <div class="tab-navigation">
        <button class="tab-button active" onclick="switchTab('account')" id="account-tab">🔐 Account</button>
        <button class="tab-button" onclick="switchTab('menu')" id="menu-tab">📦 Menu</button>
        <button class="tab-button" onclick="switchTab('cart');" id="cart-tab">🛒 Cart <span id="cart-count">0</span></button>
        <button class="tab-button" onclick="switchTab('orders')" id="orders-tab" style="display: none;">📋 Orders</button>
        <button class="tab-button" onclick="switchTab('admin')" id="admin-tab" style="display: none;">👑 Admin</button>
      </div>

      <div class="tab-content">
        <div id="account-panel" class="tab-panel active">
          <div id="signed-out-view">
            <h3 style="color: #d4691a; margin-bottom: 15px;">🔐 Account Access</h3>
          ...
          <div class="support-contact">
            <h4>Need Help?</h4>
            <p>For any questions or issues with your order, please contact us at:</p>
            <a href="mailto:covenanthillsbakery@gmail.com">covenanthillsbakery@gmail.com</a>
          </div>
        </div>

        <div id="menu-panel" class="tab-panel">
          <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">📦 Our Fresh Menu</h2>
        ...
        <div id="cart-panel" class="tab-panel">
          <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">🛒 Your Cart</h2>
          <div id="cart">
        ...
        <div id="orders-panel" class="tab-panel">
          <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">📋 My Orders</h2>
          <div id="orders-list">
        ...
        <div id="admin-panel" class="tab-panel">
          <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">👑 Admin Dashboard</h2>
          
          <!-- Admin Controls -->
          <div style="background: #27272a; color: white; padding: 25px; border-radius: 10px; margin-bottom: 20px;">
            ...
            <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 20px;">
              ...
              <button class="btn btn-secondary" onclick="toggleAdminSection('menu')">📦 Menu</button>
              <button class="btn btn-secondary" onclick="toggleAdminSection('orders')">📋 Orders</button>
              <button class="btn btn-secondary" onclick="toggleAdminSection('deals')">🏷️ Deals</button>
              <button class="btn btn-secondary" onclick="toggleAdminSection('employees')">👥 Employees</button>
              <button class="btn btn-secondary" onclick="toggleAdminSection('profit')">💰 Profit</button>
              <button class="btn btn-secondary" onclick="toggleAdminSection('pickup-times')">⏰ Pickup Times</button>
            </div>
            ...
            <div id="add-item-form" style="display:none; background: rgba(255, 255, 255, 0.1); padding: 20px; border-radius: 10px; margin-top: 20px;">
              ...
              <input id="item-cost" type="number" step="0.01" placeholder="Cost to make (e.g., 1.50)" style="margin-bottom: 10px; background: rgba(255, 255, 255, 0.9); color: #333; width: 100%;">
              ...
              <input id="item-emoji" placeholder="Emoji (e.g., 🥐)" style="margin-bottom: 15px; background: rgba(255, 255, 255, 0.9); color: #333; width: 100%;">
              <div>
          ...
          <div id="admin-menu-section" class="admin-section">
            <h3 style="color: #d4691a; margin-bottom: 15px;">📦 Menu Management</h3>
            <div id="admin-menu-items" class="menu-grid">
              <div class="empty-state"><p>Loading menu items...</p></div>
            </div>
          </div>
          
          <div id="admin-orders-section" class="admin-section" style="display: none;">
            <h3 style="color: #d4691a; margin-bottom: 15px;">📋 Order Management</h3>
            <div style="margin-bottom: 20px;">
              <button class="btn btn-secondary" onclick="loadAdminOrders('all')">All Orders</button>
              <button class="btn" onclick="loadAdminOrders('pending-payment')" style="background: #ff9800; color: white;">💳 Awaiting Payment</button>
              <button class="btn btn-primary" onclick="loadAdminOrders('pending')">📋 Pending</button>
              <button class="btn btn-success" onclick="loadAdminOrders('completed')">✅ Completed</button>
              <button class="btn btn-danger" onclick="loadAdminOrders('cancelled')">❌ Cancelled</button>
            </div>
          ...
          <div id="admin-deals-section" class="admin-section" style="display: none;">
            <h3 style="color: #d4691a; margin-bottom: 15px;">🏷️ Deal Management</h3>
            <div style="background: rgba(255, 255, 255, 0.9); padding: 25px; border-radius: 15px; margin-bottom: 20px;">
              <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 20px;">
                <button class="btn btn-success" onclick="showAddDealForm()">➕ Add New Deal</button>
                <button class="btn btn-secondary" onclick="loadDeals()">🔄 Refresh Deals</button>
              </div>
              <div id="add-deal-form" style="display: none; background: rgba(248, 249, 250, 0.9); padding: 20px; border-radius: 10px; margin-top: 20px;">
                ...
                <div>
                  <button class="btn btn-success" onclick="submitNewDeal()">💾 Create Deal</button>
                  <button class="btn btn-secondary" onclick="hideAddDealForm()">❌ Cancel</button>
                </div>
              </div>
            </div>
            <div id="deals-list">
          ...
          <div id="admin-employees-section" class="admin-section" style="display: none;">
            <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">👥 Employee Management</h2>
            <div style="background: #27272a; color: white; padding: 25px; border-radius: 10px; margin-bottom: 20px;">
              <h3 style="margin-bottom: 20px;">Employee Controls</h3>
              <div style="display: flex; gap: 10px; flex-wrap: wrap; margin-bottom: 20px;">
                <button class="btn btn-success" onclick="showAddEmployeeForm()">➕ Add New Employee</button>
          ...
          <div id="admin-profit-section" class="admin-section" style="display: none;">
            <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">💰 Daily Profit Summary</h2>
            <div id="profit-summary" class="profit-summary">
              <div class="summary-card">
                <h4>Total Revenue</h4>
                <p id="profit-revenue">$0.00</p>
              </div>
              <div class="summary-card">
                <h4>Total Costs</h4>
                <p id="profit-costs">$0.00</p>
              </div>
              <div class="summary-card net-profit">
                <h4>Net Profit</h4>
                <p id="profit-net">$0.00</p>
              </div>
            </div>
            <div id="daily-orders-breakdown">
              <h3 style="color: #d4691a; margin-top: 40px; margin-bottom: 15px;">Today's Completed Orders</h3>
              <div id="profit-orders-list">
                <div class="empty-state"><p>No completed orders today.</p></div>
              </div>
            </div>
          </div>
          
          <div id="admin-pickup-times-section" class="admin-section" style="display: none;">
            <h2 style="color: #d4691a; margin-bottom: 20px; text-align: center;">⏰ Pickup Time Management</h2>
            <div style="background: #27272a; color: white; padding: 25px; border-radius: 10px; margin-bottom: 20px;">
              <h3 style="margin-bottom: 20px;">Add New Pickup Time</h3>
              <div class="input-group">
                <input id="pickup-date-input" type="date" style="background: rgba(255, 255, 255, 0.9); color: #333;">
                <input id="pickup-time-input" type="text" placeholder="e.g., 4:00 PM - 5:00 PM" style="background: rgba(255, 255, 255, 0.9); color: #333;">
                <button class="btn btn-success" onclick="addPickupTime()">Add Time</button>
              </div>
            </div>
            <div id="pickup-times-list">
              <div class="empty-state"><p>Loading pickup times...</p></div>
            </div>
          </div>
